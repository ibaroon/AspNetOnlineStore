using MyRepository = OnlineStoreAdminPanel.Administration.Repositories.UserPermissionRepository;
using MyRow = OnlineStoreAdminPanel.Administration.UserPermissionRow;

namespace OnlineStoreAdminPanel.Administration.Endpoints;
