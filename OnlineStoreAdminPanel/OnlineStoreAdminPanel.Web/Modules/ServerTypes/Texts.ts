...
namespace OnlineStoreAdminPanel.Texts {
    ...
    export declare namespace Db {
        ...
        namespace OnlineStore {
            ...
            namespace Product {
                export const CatId: string;
                export const CatName: string;
    ...
    OnlineStoreAdminPanel['Texts'] = proxyTexts(Texts, '', {
        Db: {
            Administration: {
                Language: {},
                Role: {},
...
export const Texts = OnlineStoreAdminPanel.Texts;